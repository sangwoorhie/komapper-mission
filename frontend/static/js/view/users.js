...
export default class extends AbstractView {
  ...
  async getHtml() {
    return `
    <head>
      <link rel="stylesheet" href="../../css/users-copy.css">
    </head>
    <header>
    <img src="../../img/kmplogo_fit.png" alt="Logo" class="logo" />
  </header>
  <main>
    <section>
  ...
  <footer>
    <p>Copyright ⓒ 2024 ㈜KO-MAPPER Co.,Ltd rights reserved.</p>
  </footer>
  <!-- </div> -->
  <!-- 회원가입 모달 -->
...
{
  /* <p>
<a href="/logs" data-link>View Logs</a>.
</p> */
}
